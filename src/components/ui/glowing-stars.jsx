...
export const GlowingStarsBackgroundCard = ({ className, children }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "bg-[linear-gradient(110deg,#333_0.6%,#222)] p-6 w-full rounded-xl border border-[#eaeaea] dark:border-neutral-600 relative overflow-hidden",
        className
      )}
    >
...
export const GlowingStarsTitle = ({ className, children }) => {
  return (
    <h2 className={cn("font-bold text-2xl text-white mb-4", className)}>
      {children}
    </h2>
  );
};
...
const Star = ({ isGlowing, delay }) => {
  return (
    <motion.div
      ...
      animate={{
        scale: isGlowing ? [1, 1.2, 1.5, 1.2, 1] : 1,
